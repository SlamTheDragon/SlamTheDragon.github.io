        ...
        <div className={style.IllustrationContainer}>
            ...
            <div className={style.navigator}>
                <div className={style.subNavigator}>
                    <Button classItem={(getIllustrationType === 0) ? style.btnSelected : ''} onClick={() => { setIllustrationType(0); dispatch(setPanelFold(true)) }}>Character Illustration</Button>
                    <Button classItem={(getIllustrationType === 1) ? style.btnSelected : ''} onClick={() => { setIllustrationType(1); dispatch(setPanelFold(true)) }}>Illustration</Button>
                </div>
            </div>
        </div>
    )
