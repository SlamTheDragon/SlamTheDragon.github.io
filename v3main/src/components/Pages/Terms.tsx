...
export default function Terms() {
            ...
            <>
                ...
                {(checkDevice() ?
                    ...
                    <div className={style.sidebar} style={{ top: `${((scrollVal) >= 1180) ? 1180 : scrollVal}px` }}>
                        ...
                        <a className={style.sidebarTitle} href={`https://github.com/SlamTheDragon/SlamTheDragon.github.io`} target='_blank' rel="noreferrer">Github</a>
                    </div>
                )}
                <div className={style.spacer}></div>
    ...
    return (
        <div className={style.interfaceTerms} id='view' onScroll={transferScrollData}>
